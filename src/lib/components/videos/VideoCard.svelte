<script lang="ts">
    ...
    function getVideoTypeText(type: string): string {
        ...
        return typeMap[type] || typeMap["unset"]
    }

    function handleVideoTypeChange(type: string) {
        onVideoTypeChange(video.video_id, type)
        dropdownOpen.set(false)
    }

    function handleVideoDelete() {
        onVideoDelete(video.video_id)
    }
